...
export default function Navbar() {
  ...
  return (
    <div className="z-[100] w-full min-h-[144px]  flex items-center justify-center font-roboto mr-0 ml-2 md:ml-4 md:ml-0 fixed top-0 left-0">
      <div className="w-[95%] lg:w-4/5 min-h-[85px] rounded-lg bg-[#8576FF] bg-opacity-100 py-[24px] px-[4px] md:px-[24px] box">
