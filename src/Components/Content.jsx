...
export default function Content(){
    return(
        ...
        <div data-aos="zoom-in" data-aos-duration='1000' className="rounded-lg  w-full sm:w-[95%] md:w-[70%] shadow z-[1]"><img src={center1} alt="center" className="w-full h-full rounded-lg"/>
        </div>
