...
export default function Card() {
  ...
  return (
    <div className='md:max-w-[1104px] w-[95%] flex flex-col items-center justify-center gap-24 mt-24'>
      {/* First Card */}
      <div ref={ref1} className="md:w-full w-[95%] flex flex-col md:flex-row sm:items-center justify-center md:justify-between">
        ...
        {viewed1 &&  <div className="pl-4 md:px-0 flex flex-col items-center justify-center w-[95%] md:w-[544px] text-[#20294C]">
          <TypeAnimation sequence={['Stop worrying about exams',1000]} cursor={true} className="font-semibold text-4xl lg:text-6xl py-2 lg:py-5 leading-30 lg:leading-60 tracking-[-1.92px]" style={{ whiteSpace: "pre-line", display: "block", fontFamily: 'Source Code Pro, monospace' }} omitDeletionAnimation={true} />
      ...
      {/* Second Card */}
      <div ref={ref2} className="flex flex-col md:flex-row-reverse sm:items-center justify-center md:justify-between w-[95%]">
        <div data-aos="fade-left" data-aos-duration="1000" className='px-12 lg:px-24'>
          <img src={image21} alt="image-2" className="w-[357px]" />
        </div>
        {viewed2 && <div className="pl-4 md:px-0 flex flex-col md:w-[544px] text-[#20294C]">
      ...
      {/* Third Card */}
      <div ref={ref3} className="flex flex-col md:flex-row sm:items-center justify-center md:justify-between w-[95%]">
      ...
      {/* Fourth Card */}
      <div ref={ref4} className="flex flex-col md:flex-row-reverse sm:items-center justify-center md:justify-between w-[95%]">
        <div data-aos="fade-left" data-aos-duration="1000" className='px-12 lg:px-24'>
          <img src={image23} alt="image-4" className="w-[357px]" />
        </div>
      
  {viewed4 && ( <div className="pl-4 md:px-0 flex flex-col md:w-[544px] text-[#20294C]">
   <TypeAnimation sequence={['Stop wasting your Time', 1000]} cursor={true} className="font-semibold text-4xl lg:text-6xl py-2 lg:py-5 leading-30 lg:leading-60 tracking-[-1.92px]" style={{ whiteSpace: "pre-line", display: "block", fontFamily: 'Source Code Pro, monospace' }} omitDeletionAnimation={true} />
     <p 
      data-aos="fade-up" 
      data-aos-delay={viewed4? 0 : 1000} 
      mirror="true" 
      once="true"
