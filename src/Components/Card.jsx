    ...
    return(
        ...
        <img src={image21} alt="image-1" className="w-[357px]"/>
         ...
         <div className="pl-4 md:px-0 flex flex-col md:w-[544px] text-[#20294C]">
            <span data-aos="zoom-in" data-aos-duration="1000" className="font-semibold  text-4xl lg:text-6xl py-2 lg:py-5 leading-30 lg:leading-60 tracking-[-1.92px]" style={{fontFamily: 'Source Code Pro, monospace' }}>Stop bored- Studying</span>
        ...
        <img src={image23} alt="image-1" className="w-[357px]"/>
         ...
         <div className="pl-4 md:px-0 flex flex-col md:w-[544px] text-[#20294C]">
            <span data-aos="zoom-in" data-aos-duration="1000" className="font-semibold text-4xl lg:text-6xl py-2 lg:py-5 leading-30 lg:leading-60 tracking-[-1.92px]" style={{fontFamily: 'Source Code Pro, monospace' }}>Stop Feeling Lonely</span>
        ...
        <img src={image23} alt="image-1" className="w-[357px]"/>
         ...
         <div className="pl-4 md:px-0 flex flex-col md:w-[544px] text-[#20294C]">
            <span data-aos="zoom-in" data-aos-duration="1000" className="font-semibold text-4xl lg:text-6xl py-2 lg:py-5 leading-30 lg:leading-60 tracking-[-1.92px]" style={{fontFamily: 'Source Code Pro, monospace' }}>Stop Wasting your Time</span>
